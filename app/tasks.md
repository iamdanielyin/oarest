...
|编码|名称|类型|必输|说明|默认值|
|:---|:---|:---|:--:|:---|:-----|
|flag|查询标识|<code>digit</code>|是|0全部，1上级任务，2协同工作，3下属工作，4未汇报，5提醒，6任务汇报，7工作审批|0|
...
#新增协同
>调用该接口后，执行人会被正式添加到任务执行人中。该接口应该在用户收到协同消息并同意协同后调用，所以当前登录用户即为协同人。如果选择的协同人是同部门下的，那么会推送一条消息给协同人，然后协同人收到消息并确认同意协同后，会调用该接口，然后他就会被添加到任务的执行人中；如果要找不同部门的人参与任务协同，那么首先也会推送消息，只不过是推送给那个协同人的上级，上级如果同意了，那么协同人会被加入到任务执行人中
