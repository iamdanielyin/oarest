...
|编码|名称|类型|必输|说明|默认值|
|:---|:---|:---|:--:|:---|:-----|
|flag|查询标识|<code>digit</code>|否|0全部，1部门经理|0|
|keyword|关键字|<code>string</code>|否|当flag为0时需指定该项，模糊匹配用户姓名或用户名|无|
...
```
POST /oa/users?access_token=MmViNThiNWUtZDliZS00MTdjLWE2YzAtY2M2MTgyYjgwMmMz HTTP/1.1
Host: localhost:7778
Cache-Control: no-cache
Content-Type: application/x-www-form-urlencoded
