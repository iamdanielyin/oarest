...
|ids|ID信息|<code>string</code>|是|如果是按部门查询，那么这里是传部门ID；如果是用户查询，这里是传用户ID|无|
|started|查询开始年月|<code>string</code>|是|yyyy-MM-dd|无|
|ended|查询结束年月|<code>string</code>|是|yyyy-MM-dd|无|
...
|dept|部门效率|<code>string</code>|是|百分比，如30%|无|
|users|用户人员效率|<code>array</code>|是|如果是按部门查询，那么这个数组是该部门下所有用户的效率；如果是按用户查询，这里是所有查询用户的效率|无|
...
|:---|:---|:---|:--:|:---|:-----|
|id|ID|<code>string</code>|是|暂无|无|
|effic|部门ming|<code>string</code>|是|百分比，如30%|无|
|header|头像链接|<code>string</code>|是|暂无|无|
|realname|姓名|<code>string</code>|是|暂无|无|
...
|:---|:---|:---|:--:|:---|:-----|
|id|ID|<code>string</code>|是|暂无|无|
|effic|设备效率|<code>string</code>|是|百分比，如30%|无|
|header|头像链接|<code>string</code>|是|暂无|无|
|realname|姓名|<code>string</code>|是|暂无|无|
